...
if direction == "left":
  ...
  if action == "wait":
    colour = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Whch colour do you choose?\n").lower()
    if colour=="red":
      print("It's a room full of fire! Game Over!")
    elif colour== "blue":
      print("It's a room full of monsters! Game Over!")
    elif colour== "yellow":
